...
describe('CreateCurriculum', () => {
    ...
    it('should throw an error if getById fails', async () => {
        ...
        await expect(repo.getById(curriculumId)).rejects.toThrow('Curriculum not found');
    });
    ...
    it('should throw an error if update fails', async () => {
        ...
        await expect(repo.update(curriculumId, updateData)).rejects.toThrow('Update failed');
    });
    ...
    it('should throw an error if delete fails', async () => {
        ...
        await expect(repo.delete(curriculumId, updatedBy)).rejects.toThrow('Delete failed');
    });
